        ...
        <>
            <Box sx={{ width: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center', backgroundColor: '#000000', py: 4 }} >
                <Container maxWidth="lgBig" sx={{
                    display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column', py: {
                        md: 14,
                        xs: 8
                    ...
                    <Typography variant='h4' sx={{
                        ...
                        The Jack Herer Cup NFT gives you the ability to be a part of an exclusive club that hosts Cannabis Events Worldwide. NFT holders will receive exclusive perks, and products for each Jack Herer Cup event they
                        attend.<br />
                        <br />
